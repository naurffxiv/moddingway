...
async def decrement_strikes(self):
    try:
        ...
        logger.info(f"[strike decrement] Finished decrementing old strikes, updated {row_count} users")
    except Exception as e:
        logger.error("[strike decrement] Error when decrementing old user strikes", exc_info=e)


@decrement_strikes.before_loop
async def before_decrement_strikes():
    logger.info(f"[strike decrement] strike decrement worker started,"
